...
END SUBROUTINE
    ...
    INTEGER FUNCTION GETGMSHET(ET)
        ...
        SELECT CASE(ET)
        !LINE,2-NODE LINE
        CASE(BAR,BEAM,BAR2D,BEAM2D,FELINESEG,PIPE2,SEMI_SPHFLOW,SPHFLOW,POREFLOW)    
            GETGMSHET=1
        ...
        CASE(FEQUADRILATERAL,CPE4,CPE4_SPG,CPE4_CPL,CPS4,&
             ...
             CAX4R,CAX4R_SPG,CAX4R_CPL,ZT4_SPG,WELLBORE,WELLBORE_SPGFACE,ZT4_SPG2) 
             GETGMSHET=3 
        CASE(FETETRAHEDRON,TET4,TET4_SPG,TET4_CPL)         
            GETGMSHET=4
        CASE(FEBRICK)
            GETGMSHET=5
        CASE(PRM6,PRM6_SPG,PRM6_CPL,ZT6_SPG,ZT6_SPG2)
            GETGMSHET=6
