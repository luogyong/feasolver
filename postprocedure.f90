	...
	IF(NDATAPOINT>0) THEN
		...
		DO I=1,NDATAPOINT		
			...
			DO J=1,DATAPOINT(I).NNODE
				write(DATAPOINT_UNIT,110) I,ISTEP,ISUBTS,ITER,J,(NodalQ(DATAPOINT(I).NODE(J),K),K=1,nvo)
			END DO
...
100	FORMAT("DATASET",2X,"ISTEP",1X,"ISUBTS",3X,"ITER",5X,"NO",4X,<NVO>A15)
110 FORMAT(5I7,2X,<nvo>E15.7)
