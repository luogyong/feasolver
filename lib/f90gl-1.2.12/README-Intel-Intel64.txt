...
They have been built using Intel(R) Visual Fortran 9.1 and Intel(R) C++ Compiler 9.1 for Intel(R) 64
(formerly Intel(R) EM64T).

To use this with Intel Visual Fortran:

1.  Copy lib-Intel64\glut32.dll to your Windows System32 folder or some folder on your PATH
2.  Modify the INCLUDE/USE path to include the lib-Intel64 folder from this package.  From
...
3.  If using the IDE, add the .LIB files from the lib-Intel64 folder to your project
    (Project..Add Existing Item).  If using the command line, you will need to
    name these libraries on your link command.

If you wish to use the build scripts in this folder, copy the contents of the lib-Intel64 folder
to the lib folder.

Folder "examples" contains example programs.  Batch file mfxnio.bat will build for Intel
...
Fortran EM64T-based Applications) and type the command:
