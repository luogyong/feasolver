	...
	integer, parameter::ZT4_SPG = 129 !4 - NODED ZEROTHICKNESS 2D SEEPAGE ELEMENT, SIMULATING A 2D CUT - OFF WALL.(一维流单元,忽略平行单元的流动)
	...
	INTEGER, PARAMETER::SFR_SFRY = 76, SFR_KR = 77, SFR_KO = 78, SFR_SFRZ = 79
	INTEGER, PARAMETER::MC_C = 80, MC_PHI = 81, SLOPE_SD = 82, SFR_ALPHA = 83, SFR_PSITA = 84, SFR_MCSITA = 85

	INTEGER,PARAMETER::NF=120 !节点力，NFX,NFY,NFZ
	INTEGER,PARAMETER::NFX=120
	INTEGER,PARAMETER::NFY=121
	INTEGER,PARAMETER::NFZ=122
	...
	INTEGER, PARAMETER::PSIGMA = 101, PSIGMA1 = 101, PSIGMA2 = 102, PSIGMA3 = 103
	INTEGER, PARAMETER::XPS1 = 104, YPS1 = 105, ZPS1 = 106, XPS2 = 107, YPS2 = 108, ZPS2 = 109, XPS3 = 110, YPS3 = 111, ZPS3 = 112, APSIGMA1 = 113 !SIGMA1 作用面平行方向
	...
	!INTEGER, PARAMETER::XK1=161,YK1=162,ZK1=163,XK2=164,YK2=165,ZK2=166,XK3=167,YK3=168,ZK3=169
