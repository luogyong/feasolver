	...
	INTEGER,PARAMETER::MC_C=77,MC_PHI=78,SLOPE_SD=79,SFR_ALPHA=80,SFR_PSITA=81,SFR_MCSITA=82

	INTEGER,PARAMETER::NF=110 !节点力，NFX,NFY,NFZ
	...
	INTEGER,PARAMETER::PSIGMA=101,PSIGMA1=101,PSIGMA3=102,PSIGMA2=103,APSIGMA1=104 !SIGMA1 作用面平行方向
