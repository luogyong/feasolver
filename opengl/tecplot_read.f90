...
!3)按时间先后输出各zone的数据。
    ...
    TYPE POSDATA_TYDEF
        INTEGER::NNODE=0,NEL=0,NESET=0,NSTEP=1,NVAR=0,NDIM=2,NGRIDNODE=0,NINTERVAL=1 
        ...
        INTEGER,PUBLIC::IX=0,IY=0,IZ=0,IDISX=0,IDISY=0,IDISZ=0, &  !SPECIALL VARIABLE FOR VECTOR PAIR
                ...
                ISFR_SFRX=0,ISFR_SFRY=0,ISFR_SFRZ=0,IMC_C=0,IMC_PHI=0,&
                ISXX=0,ISYY=0,ISXY=0,ISFR=0,IH_BC=0,IQ=0,ISLOPE_SD=0,&
                IPSIGMA1=0,IPSIGMA2=0,IPSIGMA3=0,IAPSIGMA1=0,Idisx_bc=0,IDISY_BC=0,&
                ISZZ=0,ISYZ=0,ISXZ=0,IXPS1=0,IYPS1=0,IZPS1=0,IXPS2=0,IYPS2=0,IZPS2=0,IXPS3=0,IYPS3=0,IZPS3=0,IFOS=0
...
CONTAINS
    ...
    SUBROUTINE SOLVER_TO_POSDATA(POSDATA)
        ...
        ALLOCATE(POSDATA.OUTVAR(-POSDATA.NINTERVAL:NVO))
        I=-1
        POSDATA.OUTVAR(I).NAME='FOS'
        CH1=TRIM(ADJUSTL(POSDATA.OUTVAR(I).NAME))
        CALL DEFPARAM(CH1,I)
        ...
        ALLOCATE(POSDATA.NODALQ(NNUM,-POSDATA.NINTERVAL:NVO,NNODALQ))
        POSDATA.NODALQ(:,1:NVO,:)=NODALQ
        POSDATA.NODALQ(:,-POSDATA.NINTERVAL:0,:)=-1.D0
    ...
    SUBROUTINE TECPLOT_TO_POSDATA(POSDATA,TECDATA)
        ...
        ALLOCATE(POSDATA.OUTVAR(-POSDATA.NINTERVAL:POSDATA.NVAR))
        I=-1
        POSDATA.OUTVAR(I).NAME='FOS'
        CH1=TRIM(ADJUSTL(POSDATA.OUTVAR(I).NAME))
        CALL DEFPARAM(CH1,I)
        ...
        DO I=1,TECDATA.NVAR
            ...
            CALL VECTOR_VARIABLE_LOC(CH1,I)
        ENDDO
        ALLOCATE(POSDATA.NODALQ(POSDATA.NNODE,-POSDATA.NINTERVAL:POSDATA.NVAR,NSTEP))
        POSDATA.NODALQ(:,-POSDATA.NINTERVAL:0,:)=-1.D0
