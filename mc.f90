...
! a=?F/?考=C1*?考m/?考+C2*?Sbar/?考+C3*?J3/?考
!C1=?F/?考m
!C2=?F/?Sbar-tan(3*sita)/Sbar*?F/?(sqrt(Sita)
!C3=-sqrt(3.0)/(2.0*Sbar**3*cos(3*sita))*?F/?sita
!REF TO:Abbo AJ, Lyamin AV, Sloan SW, Hambleton JP. A C2 continuous approximation to the Mohr每Coulomb yield surface. International Journal of Solids and Structures. 2011;48(21):3001-10.
...
!REF TO :Abbo AJ, Lyamin AV, Sloan SW, Hambleton JP. A C2 continuous approximation to the Mohr每Coulomb yield surface. International Journal of Solids and Structures. 2011;48(21):3001-10.
SUBROUTINE KSITA_MC_C2(KSITA,LODE,SITA,PHI,SMALLA)
!LODE IN RAD,SITA IN RAD, TRANSITIONAL ANGLE.
	IMPLICIT NONE
	REAL(8),INTENT(IN)::LODE,SITA,PHI,SMALLA
...
!C2=?F/?Sbar-tan(3*sita)/Sbar*?F/?(sqrt(Sita)
!C3=-sqrt(3.0)/(2.0*Sbar**3*cos(3*sita))*?F/?sita
!?a/?考=?C2/?考*?Sbar/?考+C2*?2Sbar/?考2+?C3/?考*?J3/?考+C3*?2J3/?考2
!REF TO:[1] Abbo AJ, Lyamin AV, Sloan SW, Hambleton JP. A C2 continuous approximation to the Mohr每Coulomb yield surface. International Journal of Solids and Structures. 2011;48(21):3001-10.
