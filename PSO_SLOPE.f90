...
!THE VARIABLES: UNKNOWNS=UNS 
    ...
    REAL(8)::XT1(2),XC1(2),X1(2,SIZE(UNS)),FM1,FA1
    INTEGER::ISERROR=0,N1
    
    

    CALL UNKNOWN2SLIPS(UNS,X1,ISERROR)
    IF(ISERROR/=0) THEN
        PRINT *, "ERROR IN SLOPE_FOS_CAL.FAIL TO GET THE SLIP SURFACE WITH THE SOLUTION"
        SLOPE_FOS_CAL=1.D10
    ELSE
