subroutine write_readme_gmsh2sinp()	
	...
	open(2,file="GMSH2SINP_TEMPLATE.G2S",STATUS='REPLACE')
    ...
    README(IPP(I)) ="\N//******************************************************************************************************"C
	README(IPP(I)) = "//$HELPFILE"
	README(IPP(I))=  "//"//'"'//"THE HELPFILE IS USED TO OUTPUT A INPUT TEMPLATE FOR A G2S FILE"//'"'
    README(IPP(I)) = "//A:{ISEXIT}    //1:YES,EXIT WHEN OUTPUT IS DONE,0:NO,"  
	README(IPP(I)) = "//$ENDHELPFILE" 	
    README(IPP(I)) ="\N//******************************************************************************************************"C
