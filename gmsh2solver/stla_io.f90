...
!
  ...
  integer ( kind = 4 ) face
  integer ( kind = 4 ) ,INTENT(IN)::face_node(3,face_num)
  real ( kind = 8 ) ,INTENT(IN)::face_normal(3,face_num)
  integer ( kind = 4 ) ios
  integer ( kind = 4 ) iunit
  integer ( kind = 4 ) node
  real ( kind = 8 ) ,INTENT(IN)::node_xyz(3,node_num)
...
!
  ...
  integer ( kind = 4 ):: face
  integer ( kind = 4 ),INTENT(IN):: face_node(3,face_num)
  real ( kind = 8 ),INTENT(INOUT):: face_normal(3,face_num)
  integer ( kind = 4 ) n1
  integer ( kind = 4 ) n2
  integer ( kind = 4 ) n3
  real ( kind = 8 ),INTENT(IN)::node_xyz(3,node_num)
