...
111 FORMAT(<MODELDIMENSION>(F24.15,1X))
112 FORMAT("//",<MODELDIMENSION>(A15,1X))

120 FORMAT(/'ELEMENT,NUM=',I7,',SET=',I5,',ET=',A<ITEM>,',MATID=',I3,',COUPLESET=',I5,',SF=',I3,',ISTOPO=',I3,',TITLE=',A<ITEM1>)
...
141 FORMAT(I7,1X,I2,1X,F24.15,1X,I4)
