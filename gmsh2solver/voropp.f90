module voropp
    ...
    type voropp_face_tydef
        ...
        !for voroppcell.face, when read adjc(1)=adjancent particle id,adjc(2)= then face indice of the voroppcell.face corresponding to the the surface
...
10  format('No face pair found between cell ',i7, ' and cell ',i7,'the face area is ',g)
    ...
    subroutine voropp_read(unit)
        ...
        if(n1/=1) then
            error stop "outputformat: %i should be the in the first place."
        endif
